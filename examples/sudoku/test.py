...
print("*****************************************now it's test without rule R")
NeurASPobj = NeurASP(dprogram2, nnMapping, optimizers=None)
...
print("*****************************************now it's test of the neural network alone")
NeurASPobj = NeurASP(dprogram3, nnMapping, optimizers=None)
