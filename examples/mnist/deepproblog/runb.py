# code pour faire le test du base case. Pour que ca marche j'ai changé le batch size, modifier la normalilsation et le loss.data[0] que j'ai remplacé par loss.data
import torch
import torchvision
