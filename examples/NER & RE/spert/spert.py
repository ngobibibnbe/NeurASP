...
def __train(run_args):
    ...
    print("\n")
    print("\n")
    #print("------------sophie------------train_path:",run_args.train_path,"valid path:",run_args.valid_path,"type_path:",run_args.types_path,"input_reader_cls:",input_reader.JsonInputReader)
